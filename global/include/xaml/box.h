...
#define XAML_BOX_VTBL(type)                          \
    ...
    XAML_METHOD(set_data, type, xaml_guid XAML_CONST_REF, void const*, XAML_CSTD int32_t)
...
XAML_TYPE_NAME(XAML_CSTD int8_t, int8, { 0xdc3c96bc, 0x48ce, 0x3ef7, { 0x8c, 0x15, 0x37, 0xbc, 0x7e, 0xc8, 0x07, 0xa1 } })
XAML_TYPE_NAME(XAML_CSTD int16_t, int16, { 0xe3e8f6e4, 0xe677, 0x3436, { 0x8e, 0x0e, 0x96, 0x3d, 0x3d, 0x6f, 0x81, 0x0a } })
XAML_TYPE_NAME(XAML_CSTD int32_t, int32, { 0x0ce68e8c, 0x51a4, 0x3115, { 0xbe, 0x13, 0xdd, 0x1a, 0xce, 0x42, 0xe6, 0x1f } })
XAML_TYPE_NAME(XAML_CSTD int64_t, int64, { 0xf940ae92, 0xb495, 0x342e, { 0xab, 0x07, 0xe5, 0xff, 0x86, 0x3f, 0xb4, 0x15 } })
XAML_TYPE_NAME(XAML_CSTD uint8_t, uint8, { 0xb3b3b9f4, 0x12da, 0x3efd, { 0xb1, 0x31, 0xdf, 0x0e, 0x1f, 0x9f, 0x91, 0x4b } })
XAML_TYPE_NAME(XAML_CSTD uint16_t, uint16, { 0x33d9552a, 0xdc77, 0x3314, { 0x8e, 0xa3, 0x80, 0xbf, 0x05, 0x8e, 0xa1, 0x63 } })
XAML_TYPE_NAME(XAML_CSTD uint32_t, uint32, { 0xe38cb0a1, 0x90ae, 0x3c05, { 0x9b, 0x2e, 0x06, 0x2a, 0x58, 0x4d, 0x6c, 0x50 } })
XAML_TYPE_NAME(XAML_CSTD uint64_t, uint64, { 0x5f5fc118, 0x3099, 0x32f3, { 0xab, 0xba, 0x75, 0x57, 0x06, 0xf8, 0xb7, 0xf8 } })
