...
#ifdef __cplusplus
struct xaml_hasher : xaml_object
{
...
#define XAML_COMPARER_VTBL(type)                                      \
    ...
    xaml_result(XAML_CALL* equal)(type* const, xaml_object*, xaml_object*, _Bool*);
...
EXTERN_C XAML_API xaml_result xaml_hasher_new(xaml_result (*)(xaml_object*, XAML_CSTD size_t*), xaml_result (*)(xaml_object*, xaml_object*, XAML_BOOL*), xaml_hasher**) XAML_NOEXCEPT;
