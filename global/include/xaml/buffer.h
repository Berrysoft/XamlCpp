...
#define XAML_BUFFER_VTBL(type)                       \
    ...
    XAML_METHOD(get_data, type, XAML_CSTD uint8_t**)
...
EXTERN_C XAML_API xaml_result XAML_CALL xaml_buffer_new(XAML_CSTD int32_t, xaml_buffer**) XAML_NOEXCEPT;
EXTERN_C XAML_API xaml_result XAML_CALL xaml_buffer_new_reference(XAML_CSTD uint8_t*, XAML_CSTD int32_t, xaml_buffer**) XAML_NOEXCEPT;
