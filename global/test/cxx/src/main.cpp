...
int main()
{
    ...
    xaml_delegate_new<void, xaml_ptr<xaml_observable_vector>, xaml_ptr<xaml_vector_changed_args>>(
    ...
    bool replaced;
    XAML_THROW_IF_FAILED(map->insert(xaml_box_value(1), xaml_box_value(U("Hello world!")), &replaced));
    ...
    sf::println(cout, xaml_unbox_value<const char*>(obj1));
}
