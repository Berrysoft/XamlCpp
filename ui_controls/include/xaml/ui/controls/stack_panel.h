...
EXTERN_C XAML_UI_CONTROLS_API xaml_result XAML_CALL xaml_stack_panel_new(xaml_stack_panel**) XAML_NOEXCEPT;
EXTERN_C XAML_UI_CONTROLS_API xaml_result XAML_CALL xaml_stack_panel_members(xaml_type_info_registration*) XAML_NOEXCEPT;
EXTERN_C XAML_UI_CONTROLS_API xaml_result XAML_CALL xaml_stack_panel_register(xaml_meta_context*) XAML_NOEXCEPT;
