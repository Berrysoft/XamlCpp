...
xaml_result xaml_uniform_grid_internal::draw_impl(xaml_rectangle const& region, __xaml_function_view_wrapper_t<xaml_result(xaml_control*, xaml_rectangle const&) noexcept> func) noexcept
{
    int32_t size;
