...
xaml_result xaml_grid_internal::draw_impl(xaml_rectangle const& region, fu2::function<xaml_result(xaml_control*, xaml_rectangle const&) noexcept> func) noexcept
{
