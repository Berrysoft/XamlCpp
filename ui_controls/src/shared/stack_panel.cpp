...
xaml_result xaml_stack_panel_new(xaml_stack_panel** ptr) noexcept
{
    return xaml_object_init<xaml_stack_panel_impl>(ptr);
}

xaml_result xaml_stack_panel_members(xaml_type_info_registration* __info) noexcept
{
...
xaml_result xaml_stack_panel_register(xaml_meta_context* ctx) noexcept
{
