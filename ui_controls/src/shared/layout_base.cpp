...
xaml_result xaml_layout_base_internal::draw_impl(xaml_rectangle const&, __xaml_function_wrapper_t<xaml_result(xaml_control*, xaml_rectangle const&) noexcept>) noexcept
{
