...
#ifndef xaml_key_value_pair__xaml_string____xaml_object__defined
    #define xaml_key_value_pair__xaml_string____xaml_object__defined
XAML_KEY_VALUE_PAIR_T_T_TYPE(XAML_T_O(xaml_string), XAML_T_O(xaml_object))
#endif // !xaml_key_value_pair__xaml_string____xaml_object__defined

#ifndef xaml_enumerator__xaml_key_value_pair__xaml_string____xaml_object____defined
    #define xaml_enumerator__xaml_key_value_pair__xaml_string____xaml_object____defined
XAML_ENUMERATOR_T_TYPE(XAML_T_O(xaml_key_value_pair__xaml_string____xaml_object__))
#endif // !xaml_enumerator__xaml_key_value_pair__xaml_string____xaml_object____defined

#ifndef xaml_map_view__xaml_string____xaml_object__defined
    #define xaml_map_view__xaml_string____xaml_object__defined
XAML_MAP_VIEW_T_T_TYPE(XAML_T_O(xaml_string), XAML_T_O(xaml_object))
#endif // !xaml_map_view__xaml_string____xaml_object__defined
...
#define XAML_ELEMENT_BASE_VTBL(type)                                                      \
    ...
    XAML_METHOD(get_resources, type, XAML_MAP_VIEW_T_T_NAME(xaml_string, xaml_object)**); \
