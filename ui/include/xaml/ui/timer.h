...
#define XAML_TIMER_VTBL(type)                                       \
    ...
    XAML_PROP(interval, type, XAML_STD int32_t*, XAML_STD int32_t); \
...
EXTERN_C XAML_UI_API xaml_result XAML_CALL xaml_timer_new_interval(XAML_STD int32_t, xaml_timer**) XAML_NOEXCEPT;
