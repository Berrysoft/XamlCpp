...
#ifndef xaml_enumerator__xaml_filebox_filter__defined
    #define xaml_enumerator__xaml_filebox_filter__defined
XAML_ENUMERATOR_T_TYPE(XAML_T_V(xaml_filebox_filter))
#endif // !xaml_enumerator__xaml_filebox_filter__defined

#ifndef xaml_vector_view__xaml_filebox_filter__defined
    #define xaml_vector_view__xaml_filebox_filter__defined
XAML_VECTOR_VIEW_T_TYPE(XAML_T_V(xaml_filebox_filter))
#endif // !xaml_vector_view__xaml_filebox_filter__defined
...
#define XAML_FILEBOX_VTBL(type)                                                                                              \
    ...
    XAML_PROP(filters, type, XAML_VECTOR_VIEW_T_NAME(xaml_filebox_filter)**, XAML_VECTOR_VIEW_T_NAME(xaml_filebox_filter)*); \
...
#define XAML_OPEN_FILEBOX_VTBL(type)            \
    ...
    XAML_METHOD(get_results, type, XAML_VECTOR_VIEW_T_NAME(xaml_string)**);
