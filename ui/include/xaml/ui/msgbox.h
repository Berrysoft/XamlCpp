...
#ifndef xaml_enumerator__xaml_msgbox_custom_button__defined
    #define xaml_enumerator__xaml_msgbox_custor_button__defined
XAML_ENUMERATOR_T_TYPE(XAML_T_V(xaml_msgbox_custom_button))
#endif // !xaml_enumerator__xaml_msgbox_custom_button__defined

#ifndef xaml_vector_view__xaml_msgbox_custom_button__defined
    #define xaml_vector_view__xaml_msgbox_custom_button__defined
XAML_VECTOR_VIEW_T_TYPE(XAML_T_V(xaml_msgbox_custom_button))
#endif // !xaml_vector_view__xaml_msgbox_custom_button__defined
...
EXTERN_C XAML_UI_API xaml_result XAML_CALL xaml_msgbox_custom(xaml_window*, xaml_string*, xaml_string*, xaml_string*, xaml_msgbox_style, XAML_VECTOR_VIEW_T_NAME(xaml_msgbox_custom_button) *, xaml_msgbox_result*) XAML_NOEXCEPT;
