...
XAML_META_API xaml_result xaml_string_new(xaml_std_string_t&&, xaml_string**) noexcept;
XAML_META_API xaml_result xaml_string_new(xaml_std_string_view_t, xaml_string**) noexcept;
