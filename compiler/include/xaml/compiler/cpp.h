...
#ifdef __cplusplus
XAML_COMPILER_API xaml_result XAML_CALL xaml_compiler_cpp_compile(std::ostream&, xaml_meta_context*, xaml_node*, xaml_vector_view*) noexcept;
XAML_COMPILER_API xaml_result XAML_CALL xaml_compiler_cpp_compile_fake(std::ostream&, xaml_meta_context*, xaml_node*, xaml_string*) noexcept;
#endif // __cplusplus
