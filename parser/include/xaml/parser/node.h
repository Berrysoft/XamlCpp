...
EXTERN_C XAML_PARSER_API xaml_result XAML_CALL xaml_string_node_new(xaml_type_info*, xaml_string*, xaml_string_node**) XAML_NOEXCEPT;
...
EXTERN_C XAML_PARSER_API xaml_result XAML_CALL xaml_markup_node_new(xaml_type_info*, xaml_string*, xaml_markup_node**) XAML_NOEXCEPT;
...
EXTERN_C XAML_PARSER_API xaml_result XAML_CALL xaml_node_new(xaml_type_info*, xaml_string*, xaml_node**) XAML_NOEXCEPT;
