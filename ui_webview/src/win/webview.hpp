...
public:
    ...
    virtual xaml_result create_async(HWND parent, xaml_rectangle const& rect, __xaml_function_wrapper_t<xaml_result() noexcept> callback = {}) noexcept = 0;
...
private:                                                                                             \
    __xaml_unique_function_wrapper_t<xaml_result(arg) noexcept> m_##name{};                          \
                                                                                                     \
public:                                                                                              \
    void set_##name(__xaml_unique_function_wrapper_t<xaml_result(arg) noexcept>&& callback) noexcept \
    {                                                                                                \
